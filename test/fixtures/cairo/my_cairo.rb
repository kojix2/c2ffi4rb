...
attach_function 'cairo_tag_begin', [
  :pointer,
  :string,
  :string,
], :void

attach_function 'cairo_tag_end', [
  :pointer,
  :string,
], :void
...
Cairo_Text_Cluster_T = Anon_Type_2
...
Cairo_Text_Extents_T = Anon_Type_3
...
Cairo_Font_Extents_T = Anon_Type_4
...
attach_function 'cairo_font_options_get_variations', [
  :pointer,
], :string

attach_function 'cairo_font_options_set_variations', [
  :pointer,
  :string,
], :void
...
typedef :anon_type_8, :cairo_surface_observer_mode_t
...
attach_function 'cairo_surface_set_device_scale', [
  :pointer,
  :double,
  :double,
], :void

attach_function 'cairo_surface_get_device_scale', [
  :pointer,
  :pointer,
  :pointer,
], :void
...
Cairo_Text_Cluster_T = Anon_Type_10
...
Cairo_Text_Extents_T = Anon_Type_11
...
Cairo_Font_Extents_T = Anon_Type_12
...
typedef :anon_type_16, :cairo_surface_observer_mode_t
